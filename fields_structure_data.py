...
sotck_transaction_structure_tsmc = StockTransactionStructure(
    {
        "esc_code": Field("esc_code", (0, 1), "X(01)", "ASCII 27"),
        "message_length": Field("message_length", (1, 3), "9(04)", "PACK BCD"),
        "business_type": Field("business_type", (3, 4), "9(02)", "PACK BCD"),
        ...
        "sell_price_3": Field("sell_price_3", (85, 88), "9(4)V99", "PACK BCD"),
        "sell_volume_3": Field("sell_volume_3", (88, 92), "9(08)", "PACK BCD"),
        "check_sum": Field("check_sum", (92, 93), "X(01)", "XOR"),
        "terminal_code": Field("terminal_code", (93, 95), "X(02)", "HEXACODE"),
    }
)


sotck_transaction_structure_2002 = StockTransactionStructure(
    {
        "esc_code": Field("esc_code", (0, 1), "X(01)", "ASCII 27"),
        "message_length": Field("message_length", (1, 3), "9(04)", "PACK BCD"),
        "business_type": Field("business_type", (3, 4), "9(02)", "PACK BCD"),
        ...
        "buy_price_5": Field("buy_price_5", (64, 67), "9(4)V99", "PACK BCD"),
        "buy_volume_5": Field("buy_volume_5", (67, 71), "9(08)", "PACK BCD"),
        "check_sum": Field("check_sum", (71, 72), "X(01)", "XOR"),
        "terminal_code": Field("terminal_code", (72, 74), "X(02)", "HEXACODE"),
    }
)


sotck_transaction_structure_1504 = StockTransactionStructure(
    {
        "esc_code": Field("esc_code", (0, 1), "X(01)", "ASCII 27"),
        "message_length": Field("message_length", (1, 3), "9(04)", "PACK BCD"),
        "business_type": Field("business_type", (3, 4), "9(02)", "PACK BCD"),
        ...
        "trade_price": Field("trade_price", (29, 32), "9(4)V99", "PACK BCD"),
        "trade_volume": Field("trade_volume", (32, 36), "9(08)", "PACK BCD"),
        "sell_price_1": Field("sell_price_1", (36, 39), "9(4)V99", "PACK BCD"),
        "sell_volume_1": Field("sell_volume_1", (39, 43), "9(08)", "PACK BCD"),
        "sell_price_2": Field("sell_price_2", (43, 46), "9(4)V99", "PACK BCD"),
        "sell_volume_2": Field("sell_volume_2", (46, 50), "9(08)", "PACK BCD"),
        "sell_price_3": Field("sell_price_3", (50, 53), "9(4)V99", "PACK BCD"),
        "sell_volume_3": Field("sell_volume_3", (53, 57), "9(08)", "PACK BCD"),
        "sell_price_4": Field("sell_price_4", (57, 60), "9(4)V99", "PACK BCD"),
        "sell_volume_4": Field("sell_volume_4", (60, 64), "9(08)", "PACK BCD"),
        "sell_price_5": Field("sell_price_5", (64, 67), "9(4)V99", "PACK BCD"),
        "sell_volume_5": Field("sell_volume_5", (67, 71), "9(08)", "PACK BCD"),
        "check_sum": Field("check_sum", (71, 72), "X(01)", "XOR"),
        "terminal_code": Field("terminal_code", (72, 74), "X(02)", "HEXACODE"),
    }
)
